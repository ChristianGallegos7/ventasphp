...
<body>
    ...
    <main class="contenido mt-5">
        ...
        $query = "INSERT INTO productos_local (nombre_producto, descripcion_producto, stock, precio, imagen, id_local) VALUES ('$nombre_producto', '$descripcion_producto', '$stock', '$precio', '$imagen', '$id_local')";
