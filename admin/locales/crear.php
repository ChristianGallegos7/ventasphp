...
<body>
    ...
    <main>
        <h1 class="text-center">Formulario de local</h1>
        <div class="container card mt-5">
            <form action="procesar_formulario.php" method="POST" enctype="multipart/form-data" class="p-3">
                <!-- <div class="form-group">
                    ...
                    <input type="text" class="form-control mb-3" id="id_local" name="id_local">
                </div> -->

                <div class="form-group">
                    <label for="nombre_local">Nombre del local:</label>
                    <input type="text" class="form-control mb-3" id="nombre_local" name="nombre_local" required>
                </div>
